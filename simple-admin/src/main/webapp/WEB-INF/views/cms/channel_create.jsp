...
<%@ include file="../../common/taglib.jsp" %>
          ...
          <h4 class="sub-header">新建频道</h4>
     
          <form:form commandName="channel" servletRelativeAction="/cms/channel/save" method="post" id="cmsChannelCreateSaveForm">
          ...
          <div class="col-sm-8">
            ...
            <div class="form-group ${status.error ? 'has-error' : '' }">
              ...
              <div>
                <form:input path="channelName" cssClass="form-control" placeholder="请输入频道名称" />
              </div>
            </div>
            </spring:bind>
            ...
            <div class="form-group">
                <a class="btn btn-primary" href="javascript:;" onclick="SimpleUtil.save('#cmsChannelCreateSaveForm')" role="button">保&nbsp;存</a>
                <a class="btn btn-default" href="${pageContext.request.contextPath }/cms/channel?parentName=${channel.parentName}" role="button">返&nbsp;回</a>
            </div>
