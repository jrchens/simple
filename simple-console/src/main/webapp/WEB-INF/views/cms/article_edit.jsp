...
<%@ include file="../../common/taglib.jsp" %>
          ...
          <h4 class="sub-header">编辑文章</h4>

          <form:form commandName="article" servletRelativeAction="/cms/article/update" method="post" id="cmsArticleEditUpdateForm">
          ...
          <div class="col-sm-8">
            ...
            <div class="form-group">
              <a class="btn btn-primary" href="javascript:;"
                onclick="SimpleUtil.update('#cmsArticleEditUpdateForm')"
                role="button">保&nbsp;存</a> <a class="btn btn-default"
                href="${pageContext.request.contextPath }/cms/article"
                role="button">返&nbsp;回</a>
            </div>
          ...
          <%-- <div id="cmsArticleIndexChannelTreeview" class="col-sm-4"  dataUrl="${pageContext.request.contextPath }/cms/channel/queryUserChannel" >
          </div> --%>
